...
export const firstVolumeFlowString = Object.entries(volumeFlowUnits)[0][1]
export const firstDiameterString = Object.entries(diameterUnits)[0][1]
export const firstMassFlowString = Object.entries(massFlowUnits)[0][1]
export const firstViscosityString = Object.entries(viscosityUnits)[0][1]
export const firstDensityString = Object.entries(densityUnits)[0][1]
