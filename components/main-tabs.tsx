        ...
        <Tabs defaultValue="flow-conditions">
            ...
            <TabsContent value="flow-conditions">
                <Card className ='grid grid-fit-3 gap-5 items-center h-auto min-h-[19rem] p-3'>
                    ...
                    <Input inputMode='decimal' conditionError={conditionError.viscosity} onBlur={() => { updateCondition.flush() }} defaultValue={conditionsValues.viscosity} onChange={e => { updateCondition(e.target.value, 'viscosity') }} type='number' className='max-w-[10rem] h-7' name='viscosity'/>
