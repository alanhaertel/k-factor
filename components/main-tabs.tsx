        ...
        <Tabs defaultValue="flow-conditions">
            ...
            <TabsContent value="flow-conditions">
                <Card className ='grid grid-fit-3 gap-5 items-center h-auto min-h-[19rem] p-3'>
                    ...
                    <Input inputMode='decimal' lang='es' conditionError={conditionError.viscosity} onBlur={() => { updateCondition.flush() }} defaultValue={conditionsValues.viscosity} onChange={e => { updateCondition(e.target.value, 'viscosity') }} type='number' className='max-w-[10rem] h-7' name='viscosity'/>
            ...
            <TabsContent value="180">
                <Card className ='grid grid-fit-2 xsm:grid-fit-4 gap-5 items-center h-auto min-h-[19rem] p-3'>
                    ...
                    <InputLabel>All Types, LR (R/D = 1.5)</InputLabel>
                    <Input defaultValue={inputsValues.allTypes180} onBlur={() => { updateInput.flush() }} onChange={e => { updateInput(e.target.value, 'allTypes180') }} type='number' className='max-w-[10rem] h-7' name="C180-lr"/>
                </Card>
            </TabsContent>
            ...
            <TabsContent value="tee-thorugh">
                <Card className ='grid grid-fit-2 xsm:grid-fit-4 gap-5 items-center h-auto min-h-[19rem] p-3'>
                    ...
                    <Input defaultValue={inputsValues.stubInTeeThrough} onBlur={() => { updateInput.flush() }} onChange={e => { updateInput(e.target.value, 'stubInTeeThrough') }} type='number' className='max-w-[10rem] h-7' name="Tee-thr-branch"/>
                </Card>
            </TabsContent>
